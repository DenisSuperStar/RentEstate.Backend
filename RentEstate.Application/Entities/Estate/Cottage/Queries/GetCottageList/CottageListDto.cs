...
namespace RentEstate.Application.Entities.Estate.Cottage.Queries.GetCottageList
{
    public class CottageListDto : IMapWith<Domain.Cottage> 
    {
        ...
        public string? CottageVilageNumber { get; set; }
        public DateOnly? BuildingYear { get; set; }
        public string? ConstractMaterial { get; set; }
        ...
        public void Mapping(Profile profile) {
            profile.CreateMap<Domain.Cottage, CottageListDto>()
                ...
                .ForMember(search => search.CottageVilageNumber, option => option.MapFrom(src => src.CottageVillageNumber))
                .ForMember(search => search.BuildingYear, option => option.MapFrom(src => src.ConstructYear))
                .ForMember(search => search.ConstractMaterial, option => option.MapFrom(src => src.HouseMaterial))
