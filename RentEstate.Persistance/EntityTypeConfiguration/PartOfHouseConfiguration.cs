...
{
    public class PartOfHouseConfiguration : IEntityTypeConfiguration<PartOfHouse>
    {
        public void Configure(EntityTypeBuilder<PartOfHouse> builder)
        {
            ...
            builder.Property(prop => prop.PartForRent).IsRequired();
            builder.Property(prop => prop.HasSelfEmployed).IsRequired();
        }
    }
}
